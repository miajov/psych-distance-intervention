...
We conducted two multilevel hurdle models, one for Study 1 and another for Study 2 to examine if the within-person effects of the psychological distance reminders on drinking frequency, presented in the main manuscript, remain robust when controlling for additional demographic variables. 
